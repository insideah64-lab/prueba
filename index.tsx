          ...
          <div class="flex-1 flex gap-3 p-3 max-w-full mx-auto w-full overflow-hidden">
            ...
            <div class="flex-1 flex flex-col gap-3 min-w-0">
              ...
              <div class="flex gap-2 flex-shrink-0">
                <textarea
                  id="commandInput"
                  placeholder="Escribe tu acción libremente (ej: 'ataco al monstruo con toda mi fuerza')..."
                  class="flex-1 mud-input px-3 py-2 rounded text-sm"
                  rows="2"
                ></textarea>
                <button
                  id="sendBtn"
                  class="px-4 py-2 bg-green-700 hover:bg-green-600 rounded font-bold transition text-sm flex-shrink-0"
                >
                  Ejecutar
                </button>
              </div>
        ...
        <script>
          {`
            ...
            function updateUI(state) {
              ...
              const classXpPercent = Math.min(100, (state.classXp / (state.classLvl * 100)) * 100);
              document.getElementById("classXpFill").style.width = classXpPercent + "%";

              const jobXpPercent = Math.min(100, (state.jobXp / (state.jobLvl * 100)) * 100);
              document.getElementById("jobXpFill").style.width = jobXpPercent + "%";
